...
if(isset($_POST['submit'])){
    ...
    $insert ="INSERT INTO infopers(age,taille,poid,sexe,calo,email) VALUES ('$age','$taille','$poid','$sexe','$calo','$email')";
...
<html lang="en">
  <head>
    <title>Calcule - macrotrackr</title>
    ...
    <div>
      ...
      <div class="calcule-container">
        ...
        <h1 class="calcule-text">
          <span>Calculer votre apport calorique</span>
        </h1>
        <span>
          Pour un calcul précis, nous avons besoin de quelques informations de
          base sur vous
        </span>
        <form method="post">
